...
void JniConstants::init(JNIEnv* env) {
    ...
    errnoExceptionClass = findClass(env, "android/os/ErrnoException");
    ...
    gaiExceptionClass = findClass(env, "android/os/GaiException");
    ...
    structAddrinfoClass = findClass(env, "android/os/StructAddrinfo");
    structFlockClass = findClass(env, "android/os/StructFlock");
    structGroupReqClass = findClass(env, "android/os/StructGroupReq");
    structGroupSourceReqClass = findClass(env, "android/os/StructGroupSourceReq");
    structLingerClass = findClass(env, "android/os/StructLinger");
    structPasswdClass = findClass(env, "android/os/StructPasswd");
    structPollfdClass = findClass(env, "android/os/StructPollfd");
    structStatClass = findClass(env, "android/os/StructStat");
    structStatVfsClass = findClass(env, "android/os/StructStatVfs");
    structTimevalClass = findClass(env, "android/os/StructTimeval");
    structUcredClass = findClass(env, "android/os/StructUcred");
    structUtsnameClass = findClass(env, "android/os/StructUtsname");
}
