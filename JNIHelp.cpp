...
const char* jniStrError(int errnum, char* buf, size_t buflen) {
    ...
    // Note: glibc has a nonstandard strerror_r that returns char* rather than POSIX's int.  char
    // *strerror_r(int errnum, char *buf, size_t n); When __USE_GNU and __ANDROID_API__ >= 23
    // then bionic will provide a gnu-compatible implementation of strerror_r instead of the bsd
